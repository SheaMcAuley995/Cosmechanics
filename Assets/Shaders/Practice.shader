...
Shader "Unlit/Practice" {
    Properties {
        ...
        _bbbbbbbbbbbbbbbbb ("bbbbbbbbbbbbbbbbb", Color) = (0.5,0.5,0.5,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float4 _bbbbbbbbbbbbbbbbb;
            struct VertexInput {
            ...
            float4 frag(VertexOutput i) : COLOR {
                return fixed4(_bbbbbbbbbbbbbbbbb.rgb,0);
            }
            ENDCG
        }
        Pass {
