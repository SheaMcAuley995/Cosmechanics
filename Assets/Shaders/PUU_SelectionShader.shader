...
Shader "Custom/PUU_SelectionShader" {
    Properties {
        ...
        _2ndGlowColor ("2ndGlowColor", Color) = (0.5,0.5,0.5,1)
    }
    SubShader {
        Tags {
...
////// Specular:
                ...
                float3 node_7252 = ((_Noise_var.rgb+node_8127)*(_Noise_var.rgb*node_8127));
                float3 specularColor = (node_7252*_2ndGlowColor.rgb);
...
////// Emissive:
                ...
                float3 emissive = ((((node_6198.b*node_8545.g)*node_7252)*_GlowColor.rgb)*(_GlowIntensity*(sin((node_9453.a*_GlowPulseFrequency))*0.45+0.55)));
/// Final Color:
