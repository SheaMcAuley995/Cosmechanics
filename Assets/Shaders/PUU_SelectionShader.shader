...
Shader "Custom/PUU_SelectionShader" {
    Properties {
        ...
        _GlowIntensity ("GlowIntensity", Range(0, 50)) = 10
        ...
        _GlowPulseFrequency ("GlowPulseFrequency", Range(0.1, 5)) = 1
    }
    SubShader {
        Tags {
...
////// Emissive:
                ...
                float4 node_8997 = _Time;
                float2 node_1247 = (i.uv0+node_8997.g*float2(0,0.1));
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(node_1247, _Noise));
                float4 node_9453 = _Time;
                float3 emissive = ((((node_6198.b*node_8545.g)*_Noise_var.rgb)*_GlowColor.rgb)*(_GlowIntensity*(sin((node_9453.a*_GlowPulseFrequency))*0.45+0.55)));
/// Final Color:
