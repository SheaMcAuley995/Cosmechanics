...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:6542,x:32719,y:32712,varname:node_6542,prsc:2|diff-2520-OUT,normal-9587-RGB,emission-8540-OUT,voffset-3394-OUT,tess-7652-VOUT;n:type:ShaderForge.SFN_TexCoord,id:7426,x:31504,y:33084,varname:node_7426,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Divide,id:3394,x:31892,y:33128,varname:node_3394,prsc:2|A-9587-RGB,B-6409-OUT;n:type:ShaderForge.SFN_Vector1,id:1770,x:31669,y:33207,varname:node_1770,prsc:2,v1:8;n:type:ShaderForge.SFN_Color,id:4481,x:31285,y:32353,ptovrint:False,ptlb:node_4481,ptin:_node_4481,varname:node_4481,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Tex2d,id:9587,x:31700,y:32996,ptovrint:False,ptlb:node_9587,ptin:_node_9587,varname:node_9587,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:17da6d53ec93a0444bd0f751b1d02477,ntxv:0,isnm:True|UVIN-8196-UVOUT;n:type:ShaderForge.SFN_Panner,id:8196,x:31494,y:32940,varname:node_8196,prsc:2,spu:0.1,spv:0.1|UVIN-7426-UVOUT;n:type:ShaderForge.SFN_Multiply,id:2520,x:31663,y:32413,varname:node_2520,prsc:2|A-4481-RGB,B-9587-RGB;n:type:ShaderForge.SFN_Slider,id:6409,x:31543,y:33306,ptovrint:False,ptlb:offset,ptin:_offset,varname:node_6409,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:8.888889,max:20;n:type:ShaderForge.SFN_RgbToHsv,id:7652,x:31579,y:32567,varname:node_7652,prsc:2|IN-9587-RGB;n:type:ShaderForge.SFN_Multiply,id:8540,x:31814,y:32567,varname:node_8540,prsc:2|A-4481-RGB,B-7652-HOUT;proporder:4481-9587-6409-9382;pass:END;sub:END;*/

Shader "Custom/Tewmp" {
    Properties {
        _node_4481 ("node_4481", Color) = (0.5,0.5,0.5,1)
        _node_9587 ("node_9587", 2D) = "white" {}
        _offset ("offset", Range(0, 20)) = 8.888889
        _node_9382 ("node_9382", Range(0, 1)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_8196 = (o.uv0+node_9484.g*float2(0.1,0.1));
                ...
                float Tessellation(TessVertex v){
                    float4 node_9484 = _Time;
                    float2 node_8196 = (v.texcoord0+node_9484.g*float2(0.1,0.1));
                    float3 _node_9587_var = UnpackNormal(tex2Dlod(_node_9587,float4(TRANSFORM_TEX(node_8196, _node_9587),0.0,0)));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_9484 = _Time;
                float2 node_8196 = (i.uv0+node_9484.g*float2(0.1,0.1));
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.tangentDir = normalize( mul( unity_ObjectToWorld, float4( v.tangent.xyz, 0.0 ) ).xyz );
                o.bitangentDir = normalize(cross(o.normalDir, o.tangentDir) * v.tangent.w);
                float4 node_359 = _Time;
                float2 node_8196 = (o.uv0+node_359.g*float2(0.1,0.1));
                float3 _node_9587_var = UnpackNormal(tex2Dlod(_node_9587,float4(TRANSFORM_TEX(node_8196, _node_9587),0.0,0)));
                v.vertex.xyz += (_node_9587_var.rgb/_offset);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
                float3 lightColor = _LightColor0.rgb;
                ...
                float Tessellation(TessVertex v){
                    float4 node_359 = _Time;
                    float2 node_8196 = (v.texcoord0+node_359.g*float2(0.1,0.1));
                    float3 _node_9587_var = UnpackNormal(tex2Dlod(_node_9587,float4(TRANSFORM_TEX(node_8196, _node_9587),0.0,0)));
                    float4 node_7652_k = float4(0.0, -1.0 / 3.0, 2.0 / 3.0, -1.0);
                    float4 node_7652_p = lerp(float4(float4(_node_9587_var.rgb,0.0).zy, node_7652_k.wz), float4(float4(_node_9587_var.rgb,0.0).yz, node_7652_k.xy), step(float4(_node_9587_var.rgb,0.0).z, float4(_node_9587_var.rgb,0.0).y));
                    float4 node_7652_q = lerp(float4(node_7652_p.xyw, float4(_node_9587_var.rgb,0.0).x), float4(float4(_node_9587_var.rgb,0.0).x, node_7652_p.yzx), step(node_7652_p.x, float4(_node_9587_var.rgb,0.0).x));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
                float4 node_359 = _Time;
                float2 node_8196 = (i.uv0+node_359.g*float2(0.1,0.1));
                float3 _node_9587_var = UnpackNormal(tex2D(_node_9587,TRANSFORM_TEX(node_8196, _node_9587)));
                float3 normalLocal = _node_9587_var.rgb;
                float3 normalDirection = normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_8196 = (o.uv0+node_8797.g*float2(0.1,0.1));
                float3 _node_9587_var = UnpackNormal(tex2Dlod(_node_9587,float4(TRANSFORM_TEX(node_8196, _node_9587),0.0,0)));
                v.vertex.xyz += (_node_9587_var.rgb/_offset);
                o.pos = UnityObjectToClipPos( v.vertex );
                ...
                float Tessellation(TessVertex v){
                    float4 node_8797 = _Time;
                    float2 node_8196 = (v.texcoord0+node_8797.g*float2(0.1,0.1));
                    float3 _node_9587_var = UnpackNormal(tex2Dlod(_node_9587,float4(TRANSFORM_TEX(node_8196, _node_9587),0.0,0)));
                    float4 node_7652_k = float4(0.0, -1.0 / 3.0, 2.0 / 3.0, -1.0);
                    float4 node_7652_p = lerp(float4(float4(_node_9587_var.rgb,0.0).zy, node_7652_k.wz), float4(float4(_node_9587_var.rgb,0.0).yz, node_7652_k.xy), step(float4(_node_9587_var.rgb,0.0).z, float4(_node_9587_var.rgb,0.0).y));
                    float4 node_7652_q = lerp(float4(node_7652_p.xyw, float4(_node_9587_var.rgb,0.0).x), float4(float4(_node_9587_var.rgb,0.0).x, node_7652_p.yzx), step(node_7652_p.x, float4(_node_9587_var.rgb,0.0).x));
