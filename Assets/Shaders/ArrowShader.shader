...
////// Emissive:
                ...
                float node_6243 = ((node_266.r*_TimeMult)*_FR);
                float node_5775 = (node_6243+i.uv0.g.r).r;
                float3 emissive = ((_Emission_var.rgb*_EmissionColor.rgb)*saturate((sin((node_5775*_LineScale*6.28318530718))*2.0+-1.0)));
/// Final Color:
                outDiffuse = half4( diffuseColor, 1 );
                outSpecSmoothness = half4( specularColor, gloss );
                outNormal = half4( normalDirection * 0.5 + 0.5, 1 );
                outEmission = half4( ((_Emission_var.rgb*_EmissionColor.rgb)*saturate((sin((node_5775*_LineScale*6.28318530718))*2.0+-1.0))), 1 );
                #ifndef UNITY_HDR_ON
